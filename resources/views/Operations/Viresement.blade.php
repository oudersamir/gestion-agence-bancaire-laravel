...
success1(' le viresement fait avec succes');
      </script>
...
error1('erreur');
      ...
      @endif
      <br>
      <h4>Versement compte courant</h4>
</div>
...
<div class="container box">
   ...
   <form  action="{{url('Viresement_Compte_Courant')}}" method="post">
...
Options</h4>
  ...
  <a href="{{url('Effectuer_Viresement')}}" class="list-group-item  bg-success list-group-item-action  active"><b>Effectuer un Versement</b></a>
