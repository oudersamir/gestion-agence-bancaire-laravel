...
error1('erreur');
      ...
      @endif
      <br>
      <h4>Retrait de  Compte Epargne</h4>
</div>
...
<div class="container box">
   ...
   <form action="{{url('Retrait_Compte_Epargne')}}" method="post">
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input type="text" name="solde" id="solde11" class="form-control" readonly>
    </div>
    <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="number" class="form-control" name="montant" id="inputPassword4" placeholder="montant" >
    </div>
  </div>
        <input id="idcompteepargne33" name="idcompteepargne" type="hidden">
...
Options</h4>
  ...
  <a href="{{url('Effectuer_Retrait_Epargne')}}" class="list-group-item bg-success list-group-item-action active"><b>Effectuer un Retrait</b></a>
