	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="index.html"><img src="{{asset('assets/htm/images/euroLogo.png')}}" alt=""></a>
				</div>
				...
				<nav id="navigation" class="style-1">
					<ul id="responsive">
						...
						<li><a href="#">Mes Comptes</a>
							<ul>
								<li><a href="{{ url('comptes') }}">Comptes courants</a></li>
								<li><a href="{{ url('cmptepargnes') }}">Comptes epargnes</a></li>
							</ul>
						</li>

						<li><a href="#">Operations</a>
							<div class="mega-menu mobile-styles four-columns">

									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Creation Comptes</li>
									...
									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Modification Comptes</li>
									...
									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Encaissement</li>
									...
									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Virement</li>
											<li><a href="pages-contact.html"><i class="sl sl-icon-envelope-open"></i> Contact</a></li>
											<li><a href="pages-coming-soon.html"><i class="sl sl-icon-hourglass"></i> Coming Soon</a></li>
											<li><a href="pages-404.html"><i class="sl sl-icon-close"></i> 404 Page</a></li>
											<li><a href="pages-masonry-filtering.html"><i class="sl sl-icon-equalizer"></i> Masonry Filtering</a></li>
									...
									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Versement</li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i> User Profile</a></li>
											<li><a href="pages-booking.html"><i class="sl sl-icon-check"></i> Booking Page</a></li>
											<li><a href="pages-add-listing.html"><i class="sl sl-icon-plus"></i> Add Listing</a></li>
											<li><a href="pages-blog.html"><i class="sl sl-icon-docs"></i> Blog</a></li>
									...
									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Retrait</li>
											<li><a href="pages-contact.html"><i class="sl sl-icon-envelope-open"></i> Contact</a></li>
											<li><a href="pages-coming-soon.html"><i class="sl sl-icon-hourglass"></i> Coming Soon</a></li>
											<li><a href="pages-404.html"><i class="sl sl-icon-close"></i> 404 Page</a></li>
											<li><a href="pages-masonry-filtering.html"><i class="sl sl-icon-equalizer"></i> Masonry Filtering</a></li>
 	...
 	<div class="main-search-inner">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2>SamirBank</h2>
					<h4>reserch ever u want there</h4>
...
<!--hhh			<div class="category-box-container half">
				<a href="listings-half-screen-map-grid-1.html" class="category-box" data-background-image="htm/images/category-box-01.jpg">
			...
			<div class="category-box-container half">
				<a href="listings-half-screen-map-grid-1.html" class="category-box" data-background-image="htm/images/category-box-02.jpg">
					<div class="category-box-content">
						<h3>Shops</h3>
...
hhh-->
		...
		<div class="fw-carousel-item">
			<div class="category-box-container">
				<a href="listings-half-screen-map-grid-1.html" class="category-box" data-background-image="htm/images/category-box-03.jpg">
					<div class="category-box-content">
						<h3>Events</h3>
		...
		<div class="fw-carousel-item">
			<div class="category-box-container">
				<a href="listings-half-screen-map-grid-1.html" class="category-box" data-background-image="htm/images/category-box-04.jpg">
					<div class="category-box-content">
						<h3>Fitness</h3>
		...
		<div class="fw-carousel-item">
			<div class="category-box-container">
				<a href="listings-half-screen-map-list.html" class="category-box" data-background-image="htm/images/category-box-05.jpg">
					<div class="category-box-content">
						<h3>Nightlife</h3>
		...
		<div class="fw-carousel-item">
			<div class="category-box-container">
				<a href="listings-half-screen-map-list.html" class="category-box" data-background-image="htm/images/category-box-06.jpg">
					<div class="category-box-content">
						<h3>Eat & Drink</h3>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="carousel-item">
					<a href="listings-single-page.html" class="listing-item-container">
						<div class="listing-item">
							<img src="htm/images/listing-item-01.jpg" alt="">
				...
				<div class="carousel-item">
					<a href="listings-single-page.html" class="listing-item-container">
						<div class="listing-item">
							<img src="htm/images/listing-item-02.jpg" alt="">
				...
				<div class="carousel-item">
					<a href="listings-single-page.html" class="listing-item-container">
						<div class="listing-item">
							<img src="htm/images/listing-item-03.jpg" alt="">
							<div class="listing-item-details">
								<ul>
				...
				<div class="carousel-item">
					<a href="listings-single-page.html" class="listing-item-container">
						<div class="listing-item">
							<img src="htm/images/listing-item-04.jpg" alt="">
				...
				<div class="carousel-item">
					<a href="listings-single-page.html" class="listing-item-container">
						<div class="listing-item">
							<img src="htm/images/listing-item-05.jpg" alt="">
							<div class="listing-item-content">
				...
				<div class="carousel-item">
					<a href="listings-single-page.html" class="listing-item-container">
						<div class="listing-item">
							<img src="htm/images/listing-item-06.jpg" alt="">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<a href="pages-blog-post.html" class="blog-compact-item-container">
					<div class="blog-compact-item">
						<img src="htm/images/blog-compact-post-01.jpg" alt="">
			...
			<div class="col-md-4">
				<a href="pages-blog-post.html" class="blog-compact-item-container">
					<div class="blog-compact-item">
						<img src="htm/images/blog-compact-post-02.jpg" alt="">
						<span class="blog-item-tag">Tips</span>
						<div class="blog-compact-item-content">
							<ul class="blog-post-tags">
			...
			<div class="col-md-4">
				<a href="pages-blog-post.html" class="blog-compact-item-container">
					<div class="blog-compact-item">
						<img src="htm/images/blog-compact-post-03.jpg" alt="">
						<span class="blog-item-tag">Tips</span>
						<div class="blog-compact-item-content">
							<ul class="blog-post-tags">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-5 col-sm-6">
				<img class="footer-logo" src="{{asset('assets/htm/images/euroLogo.png')}}" alt="">
				<br><br>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="copyrights">© 2019 SamirBank. All Rights Reserved.</div>
			</div>
		</div>
...
<!-- Scripts
================================================== -->
<script type="text/javascript" src="assets/htm/scripts/jquery-2.2.0.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/mmenu.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/chosen.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/slick.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/rangeslider.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/magnific-popup.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/waypoints.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/counterup.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/jquery-ui.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/tooltips.min.js"></script>
<script type="text/javascript" src="assets/htm/scripts/custom.js"></script>


<!-- Style Switcher
================================================== -->
<script src="htm/scripts/switcher.js"></script>
